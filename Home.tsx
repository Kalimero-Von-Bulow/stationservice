...
export default function Home() {
  ...
  // Chargement du script Gumroad embed
  useEffect(() => {
  ...
  return (
    <div style={{ backgroundColor: bgColor, color: textColor, fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: "600px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: "1.5rem", justifyContent: "center", flexWrap: "wrap", marginTop: "2rem" }}>
            ...
            {/* Gumroad embed — remplace le lien PRNGRFX */}
            <div
              style={{
                minWidth: "280px",
                flex: 1,
            ...
            >
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: '<a href="https://kalimero666.gumroad.com/l/wqynnc">Loading...</a>',
                }}
              />
            </div>
      ...
      {/* Ko-Fi button */}
      <div style={{ backgroundColor: bgColor, padding: "2rem 1.5rem", display: "flex", justifyContent: "center" }}>
        <a
